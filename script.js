...
const showUI = (list) => {
    list.forEach((obj) => {
        ...
        newCard.classList.add("video-preview");

        newCard.addEventListener("click", () => {
            window.open(`./video.html?id=${obj.videoId}`, "_top");
        });
        const authorThumbnailUrl = `https://yt3.googleusercontent.com/${obj.authorId}/photo.jpg`;
        newCard.innerHTML = `
            <div class="thumbnail-row">
                <img class="thumbnail" src="${obj.videoThumbnails[0].url}" alt="${obj.title}">
                <div class="video-time">${formatDuration(obj.lengthSeconds)}</div>
            </div>
            <div class="video-info-grid">
                ...
                <div class="video-info">
                    <p class="video-title">${obj.title}</p>
                    <p class="video-author">${obj.author} </p>
                    <p class="video-stats">${obj.viewCountText} · ${obj.publishedText}</p>
                </div>
            </div>
        `;
